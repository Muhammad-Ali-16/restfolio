        ...
        <section className='teams-main relative py-14 lg:py-20'>
            <div className='teams-content-main max-w-common px-2'>
                ...
                <div className="teams-heading" data-aos="fade-in">
                    <h1 className="teams-heading text-3xl xl:text-5xl font-bold my-6 text-[var(--text-light)]">Our Team Members</h1>
                    <h4 className="teams-sub-heading max-w-2xl mb-10">Proin at lorem justo. Sed maximus risus hendrerit ipsum sodales, vel consequat dui ultrices. Vestibulum ante ipsum primis in faucibus orci luctus.</h4>
                </div>
