        ...
        <ul className={`${Name}-links ${AdditonalClass} ${ClassToggle} flex-col xl:flex-row space-x-7 text-lg xl:text-xl mx-auto relative transition-all duration-600`}>
            ...
            <li className={`${Name}-link relative transition duration-200`}>
                <div className="inline-block group">
                    ...
                    {/* -----------Nav-SubLinks---------- */}
                    <div className={`${AdditonalClass} relative xl:absolute max-xl:group-hover:relative w-56 bg-transparent xl:bg-white opacity-100 xl:opacity-0 transition-all duration-200 text-[var(--text-primary)] xl:text-black/70 xl:translate-y-8 group-hover:translate-y-0 group-hover:opacity-100 rounded-lg xl:top-8 xl:-left-7 pointer-events-none group-hover:pointer-events-auto`}>
