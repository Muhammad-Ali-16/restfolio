...
function About() {
    return (
        <section
            className={`about-main w-full relative h-auto pb-15 overflow-hidden 
        ...
        >
            <div className='about-content-main max-w-common grid grid-cols-6 content-center'>
                ...
                <div className="about-heading-main text-[var(--text-light)] font-semibold col-span-full xl:col-span-4 xl:col-start-2 xl:col-end-7 xl:max-w-2xl w-full px-auto lg:px-5 pt-15 xl:pt-36">
                    <h1 className='text-4xl lg:text-5xl xl:text-7xl xl:leading-22 leading-13'>Certified Restfolio Restaurant Brand Since 1997</h1>
                </div>
                {/* -----------About-Content---------- */}
                <div className="about-content grid grid-rows-1 grid-cols-3 col-span-full mt-16 gap-9">
                    <img src={AboutImg1} alt="about-img" className='col-span-full xl:col-span-1 place-self-center' />
                    <div className="about-discription col-span-full xl:col-span-1 space-y-10 lg:text-[13px] xl:text-[15px]">
                        ...
                        <Button Text='More About +' Name="about-btn" AdditonalClass='bg-[var(--text-secondary)] text-[var(--text-light)] mt-6' />
                    </div>
                    <img src={AboutImg2} alt="about-img" className='hidden xl:block max-w-sm relative -top-40' />
                </div>
            </div>
        </section>
    )
